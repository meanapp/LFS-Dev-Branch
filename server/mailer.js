...
exports.registerUser = function(userEmail,firstName){
                console.log("inside Register-->");
                console.log("printing userEmail--> "+userEmail+" firstname--> "+firstName);
...
exports.newLeaveRequestEmp = function(userEmail,firstName,fromDate,toDate){
                ...
                var template=fs.readFileSync('./views/LeaveCreated.hjs','utf-8');
                                ...
                                sendgrid.send({
                                        ...
                                        html :    compiledTemplate.render({firstName: firstName},{fromDate:fromDate},{toDate:toDate})
                                }, function(err, json) {
...
exports.leaveStatus= function(userEmail,firstName,leaveStatus,fromDate,toDate){
            ...
            var template=fs.readFileSync('./views/LeaveStatus.hjs','utf-8');
                                ...
                                sendgrid.send({
                                        ...
                                        html :    compiledTemplate.render({firstName: firstName},{fromDate:fromDate},{toDate:toDate},{leaveStatus:leaveStatus})
                                }, function(err, json) {
                                    if (err) { new mailStatus({
                                            userEmailAddress: userEmail,
                                            time : Date.now(),
